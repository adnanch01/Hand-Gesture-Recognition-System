...
CSV = Path("model/point_history_classifier/point_history.csv")
KERAS_OUT = Path("model/point_history_classifier/point_history_classifier.keras")
TFLITE_OUT = Path("model/point_history_classifier/point_history_classifier.tflite")
...
def build(input_dim, n_classes):
    ...
    x = tf.keras.layers.Dense(128, activation="relu")(inp); x = tf.keras.layers.Dropout(0.2)(x)
